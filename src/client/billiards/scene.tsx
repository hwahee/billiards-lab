 ...
 * The predicted paths.
 *
 * The scene subtree re-renders whenever anything on the page changes — every
 * pointer move of an aim drag, for one — but a path is hundreds of points
 * and a fat line rebuilds its whole geometry when the array it is given is a
 * new one. So the scene-space arrays are derived once per set of paths: an
 * unchanged prediction then hands <Line> the identical array and costs
 ...
 * than to any one scheme, so every way of aiming can be finished the same
 * way — and it appears under exactly the same conditions as the aim widgets
